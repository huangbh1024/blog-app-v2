...
let _isDark: boolean
function toggleDark(theme: 'light' | 'dark' | 'system') {
...
function toggleViewTransition(event: MouseEvent, theme: 'light' | 'dark' | 'system') {
...
function toggleTheme(event: MouseEvent, theme: 'light' | 'dark' | 'system') {
  const isSupport
    // @ts-expect-error: Transition API
